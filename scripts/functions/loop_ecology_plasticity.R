...
loop_ecology2 <- function (config, data, vars, plast_value, tolerance) {
  ...
  for (cell in occupied_cells) {
    ...
    NEW_abd <- config$gen3sis$ecology$apply_ecology(abundance, traits, local_environment, config, plast_value, tolerance)
